...
export default function Dashboard() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="flex-1 flex flex-col">
        <header className="sticky top-0 z-10 bg-white w-full dark:bg-gray-800 shadow-lg">
          <div className="w-full px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center">
                <button
                  onClick={toggleSidebar}
                  className="text-gray-500 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-purple-500 p-2 rounded-md md:hidden"
                >
                  <Menu size={24} />
                </button>
                <h1 className="ml-2 text-xl font-bold text-gray-900 dark:text-white md:hidden">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-[#ebd5ff] dark:bg-[#1F1F1F]">
          <div
            className={`max-w-[68rem] mx-auto px-4 sm:px-6 lg:px-8 mt-[2rem] ${
              !sidebarOpen ? "ml-0 lg:ml-[10rem]" : ""
            }`}
          >
            <div className="bg-[#f4e8ff] dark:bg-gray-600 rounded-lg shadow-md">
              <div className="p-6">
