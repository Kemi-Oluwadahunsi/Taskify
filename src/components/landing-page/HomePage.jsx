...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 text-white max-w-7xl mx-auto ">
//       <Header />
...
//             TaskMaster is your ultimate free personal task manager, designed to
